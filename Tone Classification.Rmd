...
train <- voice_reports_clean[tindex,c("total.duration", "intensity", "spectraltilt", "mean.F0", "noise", "tone")]
test <- voice_reports_clean[-tindex,c("total.duration", "intensity", "spectraltilt", "mean.F0", "noise", "tone")]

svm_model <- svm(tone ~ total.duration + intensity + spectraltilt + mean.F0 + noise, data=train, 
