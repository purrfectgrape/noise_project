...
```{r}
logit_creaky = glm(creaky ~  mean.F0 + total.duration + intensity + spectraltilt + number.pulses + mean.HNR, family = "binomial", data=voice_reports_clean)
...
# library("kknn")
# 
# # I set the parameters of trainControl to be method ~ repeatedcv, 5 folds, # and 3 repeats.
